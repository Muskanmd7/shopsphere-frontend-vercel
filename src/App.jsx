    ...
    <BrowserRouter>
      <AppProvider>
        ...
        <Routes>
          ...
          <Route path="*" element={
            <PublicLayout>
              <div className="min-h-[70vh] flex items-center justify-center text-center px-4 bg-hero-pastel">
                <div>
                  <p className="text-8xl font-display font-semibold text-primary-100 mb-4">404</p>
                  <h2 className="font-display text-2xl font-semibold text-surface-800 mb-2">Page not found</h2>
                  <p className="text-surface-300 mb-6 text-sm">The page you're looking for doesn't exist.</p>
